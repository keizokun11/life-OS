import { DEFAULT_SETTINGS, deepDefaults, dateKey, addDays, generateDayPlan, forecastDeadlineRisks, minutesLabel, timeLabel, toMinutes, taskMinutesPerPage } from './scheduler.js?v=1.5.2';
...
function taskFormValues(t){return t||taskDraft||{taskType:'study',title:'',deadline:addDays(dateKey(),30),deadlineTime:'23:59',remainingPages:30,baseMinutesPerPage:3,remainingMinutes:60,quantityText:'',courseId:'',assignmentType:'weekly',priority:'medium',focus:'main',mode:'grow',timePreference:'any',minPages:5,maxPages:30,minBlock:20,maxBlock:120,placement:'flexible',fixedDate:dateKey(),fixedTime:'09:00',fixedPages:5,fixedMinutes:30};}
