import { DEFAULT_SETTINGS, deepDefaults, dateKey, addDays, generateDayPlan, forecastDeadlineRisks, minutesLabel, timeLabel, toMinutes, taskMinutesPerPage } from './scheduler.js?v=1.5.3';

const APP_VERSION = '1.5.3';
const DATA_SCHEMA_VERSION = 10;
const DATA_KEYS = ['tasks','events','overrides','settings','dayModes','dayStates','dailySleepPlans','wakeRecords','activityLog','operationLog','planSnapshots','ideas','closeouts','activeSession','semesters','classExceptions','motivation','calendarSources'];
const CLOUD_KEYS = ['tasks','overrides','settings','dayModes','dayStates','dailySleepPlans','wakeRecords','activityLog','operationLog','planSnapshots','ideas','closeouts','activeSession','semesters','classExceptions','motivation','calendarSources'];
...
function taskFormValues(t){
  ...
  return {
    ...
    deadline:base.deadline||addDays(dateKey(),30), deadlineTime:base.deadlineTime||'23:59', startDate:base.startDate||dateKey(),
